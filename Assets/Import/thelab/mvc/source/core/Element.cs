...
namespace thelab.mvc
{
    ...
    public class Element : MonoBehaviour {
        ...
        /// <param name="p_global"></param>
        /// <returns></returns>
        public T Assert<T>(T p_var, bool includeDisabled, bool p_global = false) where T : Object {
            return p_var == null ? (p_global ? GameObject.FindObjectOfType<T>() : transform.GetComponentInChildren<T>(includeDisabled)) : p_var;
        }
        ...
        /// <param name="p_global"></param>
        /// <returns></returns>
        public T[] AssertArray<T>(T[] p_var, bool p_global = false) where T : Object {
            
            return p_var == null ? (p_global ? GameObject.FindObjectsOfType<T>() : transform.GetComponentsInChildren<T>()) : p_var;
        }
        ...
        /// <param name="p_global"></param>
        /// <returns></returns>
        public T[] AssertArray<T>(T[] p_var, bool includeDisabled, bool p_global = false) where T : Object {

            return p_var == null ? (p_global ? GameObject.FindObjectsOfType<T>() : transform.GetComponentsInChildren<T>(includeDisabled)) : p_var;
        }
